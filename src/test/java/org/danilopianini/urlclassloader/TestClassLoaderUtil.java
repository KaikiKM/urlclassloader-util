...
public class TestClassLoaderUtil {
    private static final String WORKDIR = System.getProperty("user.home") + File.separator + "testURLClassLoader";
    ...
    private static URL res() {
        return TestClassLoaderUtil.class.getClassLoader().getResource(FILENAME);
    }
